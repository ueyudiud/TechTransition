...
import ttr.core.gui.machine.eletrical.ContainerPressor;
import ttr.core.gui.machine.eletrical.GuiPressor;
import ttr.core.tile.TEElectricalMachineRecipeMapTemplate;
import ttr.load.TTrLangs;

/**
 * Created at 2016年12月21日 下午3:05:49
 * @author ueyudiud
 */
public class TEElectricalPressor extends TEElectricalMachineRecipeMapTemplate implements IContainerableTile
{
	public TEElectricalPressor()
	{
		super(2, 1, 0, 0, 16384, 1);
		this.inventory = new Inventory(1, TTrLangs.elePressor, 64);
	}
	
	@Override
	public Container getContainer(EnumFacing side, EntityPlayer player)
	{
		return new ContainerPressor(player, this);
	}
	...
	{
		return new GuiPressor(player, this);
	}
