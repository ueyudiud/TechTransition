...
import ttr.core.gui.machine.eletrical.ContainerCompressor;
import ttr.core.gui.machine.eletrical.GuiCompressor;
 ...
 * @author ueyudiud
 */
public class TEElectricalCompressor extends TEElectricalMachineRecipeMapTemplate implements IContainerableTile
{
	public TEElectricalCompressor()
	{
		super(1, 1, 0, 0, 16384, 1);
		this.inventory = new Inventory(1, TTrLangs.eleCompressor, 64);
	}
	
	@Override
	public Container getContainer(EnumFacing side, EntityPlayer player)
	{
		return new ContainerCompressor(player, this);
	}
	...
	{
		return new GuiCompressor(player, this);
	}
	
	@Override
	protected TemplateRecipeMap getRecipeMap()
	{
		return TemplateRecipeMap.COMPRESS;
	}
}