 ...
 * @author ueyudiud
 */
public class ContainerAssembler extends ContainerTPC<TEElectricalAssembler>
{
	public ContainerAssembler(EntityPlayer player, TEElectricalAssembler inventory)
	{
