...
import ttr.core.gui.machine.eletrical.ContainerAssembler;
import ttr.core.gui.machine.eletrical.GuiAssembler;
import ttr.core.tile.TEElectricalMachineRecipeMapTemplate;
import ttr.load.TTrLangs;

/**
 * Created at 2016年12月21日 下午3:06:48
 * @author ueyudiud
 */
public class TEElectricalAssembler extends TEElectricalMachineRecipeMapTemplate implements IContainerableTile
{
	public TEElectricalAssembler()
	{
		super(2, 1, 1, 0, 16384, 1);
		this.inventory = new Inventory(1, TTrLangs.eleAssembler, 64);
	}
	...
	{
		return TemplateRecipeMap.ASSEMBLE;
	}
}