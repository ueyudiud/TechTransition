...
public class GuiEFurnace extends GuiContainerBase
{
	protected TEElectricalFurnace tile;
	
	public GuiEFurnace(EntityPlayer player, TEElectricalFurnace tile)
	{
		super(new ContainerEFurnace(player, tile));
		this.tile = tile;
	}
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/e_furnace.png");
	}
