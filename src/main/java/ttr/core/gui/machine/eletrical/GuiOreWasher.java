...
public class GuiOreWasher extends GuiContainerBase
{
	protected TEElectricalOreWasher tile;
	
	public GuiOreWasher(EntityPlayer player, TEElectricalOreWasher tile)
	{
		super(new ContainerOreWasher(player, tile));
		this.tile = tile;
	}
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/ore_washer.png");
	}
