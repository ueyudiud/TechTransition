...
public class MC
{
	...
	public static final MatCondition plate = new MatCondition("plate", "Plate", "%s Plate").setSize(1296L, 648L).setFilter(new IDataChecker.Or(SubTag.METAL, SubTag.GEN_COAL, SubTag.ROCK, SubTag.MONCRYSTAL));
	...
	public static final MatCondition moncrystal = new MatCondition("moncrystal", "Moncrystal", "%s Moncrystal").setSize(2592L).setFilter(SubTag.MONCRYSTAL);
