...
public class GuiExtractor extends GuiContainerBase
{
	protected TEElectricalExtractor tile;
	
	public GuiExtractor(EntityPlayer player, TEElectricalExtractor tile)
	{
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/extractor.png");
	}
