...
{
	public static final IDataChecker TRUE = new Constant(true);
	public static final IDataChecker FALSE = new Constant(false);

	boolean isTrue(T target);
	
	static class Constant implements IDataChecker
	{
		boolean flag;
			...
			return obj == this ? true :
				(obj == null || this == null) ? false :
					(!(obj instanceof Not)) ? false :
						Util.equal(((Not) obj).check, check);
		}
	}
			...
			return obj == this ? true :
				(obj == null || this == null) ? false :
					(!(obj instanceof Xor)) ? false :
						(Util.equal(((Xor) obj).check1, check1) && Util.equal(((Xor) obj).check2, check2)) ||
						(Util.equal(((Xor) obj).check1, check2) && Util.equal(((Xor) obj).check2, check1));
		}
	}
			...
			return obj == this ? true :
				(obj == null || this == null) ? false :
					(!(obj instanceof Equal)) ? false :
						(Util.equal(((Equal) obj).check1, check1) && Util.equal(((Equal) obj).check2, check2)) ||
						(Util.equal(((Equal) obj).check1, check2) && Util.equal(((Equal) obj).check2, check1));
		}
	}
}