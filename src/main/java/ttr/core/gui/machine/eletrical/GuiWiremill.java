...
public class GuiWiremill extends GuiContainerBase
{
	protected TEElectricalWiremill tile;
	
	public GuiWiremill(EntityPlayer player, TEElectricalWiremill tile)
	{
		super(new ContainerWiremill(player, tile));
		this.tile = tile;
	}
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/wiremill.png");
	}
