...
public class GuiBender extends GuiContainerBase
{
	protected TEElectricalBender tile;
	
	public GuiBender(EntityPlayer player, TEElectricalBender tile)
	{
		super(new ContainerBender(player, tile));
		this.tile = tile;
	}
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/bender.png");
	}
