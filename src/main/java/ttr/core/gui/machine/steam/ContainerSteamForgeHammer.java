...
public class ContainerSteamForgeHammer extends ContainerTPC<TESteamForgeHammer>
{
	public ContainerSteamForgeHammer(EntityPlayer player, TESteamForgeHammer inventory)
	{
