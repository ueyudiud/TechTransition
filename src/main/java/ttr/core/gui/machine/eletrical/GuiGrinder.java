...
/**
 * Created at 2016年12月21日 下午12:58:04
 * @author ueyudiud
 */
@SideOnly(Side.CLIENT)
public class GuiGrinder extends GuiContainerBase
{
	protected TEElectricalGrinder tile;
	
	public GuiGrinder(EntityPlayer player, TEElectricalGrinder tile)
	{
		super(new ContainerGrinder(player, tile));
		this.tile = tile;
	}
	...
	{
		return new ResourceLocation("ttr", "textures/gui/machine/electric/grinder.png");
	}
