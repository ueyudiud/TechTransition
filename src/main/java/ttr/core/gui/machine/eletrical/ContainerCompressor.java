 ...
 * @author ueyudiud
 */
public class ContainerCompressor extends ContainerTPC<TEElectricalCompressor>
{
	public ContainerCompressor(EntityPlayer player, TEElectricalCompressor inventory)
	{
