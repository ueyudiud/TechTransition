...
import ttr.core.gui.machine.eletrical.ContainerEFurnace;
import ttr.core.gui.machine.eletrical.GuiEFurnace;
 ...
 * @author ueyudiud
 */
public class TEElectricalFurnace extends TEElectricalMachineRecipeMapTemplate implements IContainerableTile
{
	public TEElectricalFurnace()
	{
		super(1, 1, 0, 0, 16384, 1);
		this.inventory = new Inventory(1, TTrLangs.eleFurnace, 64);
	}
	...
	{
		return new ContainerEFurnace(player, this);
	}
	...
	{
		return new GuiEFurnace(player, this);
	}
